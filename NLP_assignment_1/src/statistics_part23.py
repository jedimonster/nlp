...
class SimpleUnigramTagger(TaggerI):
    ...
    def get_bad_entropy(self):
        ...
        print "precentage of bad entropy tokes to overall tokens: ", float(self.bad_entropy_count)/float(self.overall_words_tagged)
        print "precentage of bad entropy unique words to overall unique words: ", float(len(self.distinct_bad_entropy))/float(self.get_overall_distinct())
    def get_overall_words(self):
        return self.overall_words_tagged
    ...
    def get_nones(self):
        ...
        print "precentage of none tokesns to overall tokes: ", float(self.overall_nones)/float(self.overall_words_tagged)
        print "precentage of unique nones to overall unique ", float(len(self.distinct_nones))/float(self.get_overall_distinct())
if __name__ == "__main__":
    ...
    print "number of options per word is:"
    print u1.get_number_of_options_per_word()
    u1.get_bad_entropy()
    u1.get_nones()
